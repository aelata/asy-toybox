...
## Graph of real part and imaginary part
...
## Graph of absolute value and argument
...
## Representing complex values as colors
...
Following 4 tools are introduced:

* gnuplot
* viscomplexr (R language)
* cplot (Python language)
* domcol.asy (Asymptote language)

Other [MATLAB](https://mathworks.com/products/matlab.html) tools are also available
...
#### White corresponds to zeros and black to poles {.c}
...
[cplot](https://github.com/nschloe/cplot) is a package to plot complex functions in [the Python language](https://www.python.org)

![](ex-cplot.svg){.C}

#### Black corresponds to zeros and white to poles {.c}
...
[domcol.asy](https://github.com/aelata/asy-toybox/blob/main/domcol.asy) is a module for domain coloring in [Asymptote](https://asymptote.sourceforge.io)
